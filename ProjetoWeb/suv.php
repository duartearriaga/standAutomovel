...
<body>
    ...
    <div class="mainContainer">
        ...
        <div class="mainRight">
            <p class="location-bar">Página Inicial > SUV</p>
            <div class="rightItems">
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='suv' order by id_carro ASC LIMIT 4";
                ...
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='suv' and id_carro > 4 order by id_carro ASC LIMIT 4";
                        $connect = mysqli_query($con, $select);
