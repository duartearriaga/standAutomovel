...
<meta charset="UTF-8">
    ...
    <title>Coleção / AutoDuarte</title>
...
<body>
    ...
    <div class="mainContainer">
        ...
        <div class="mainRight">
            <p class="location-bar">Página Inicial > Coleção</p>
            <div class="rightItems">
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='colecao' order by id_carro ASC LIMIT 4";
                ...
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='colecao' and id_carro > 4 order by id_carro ASC LIMIT 4";
                        $connect = mysqli_query($con, $select);
