...
<meta charset="UTF-8">
    ...
    <title>Desportivo / AutoDuarte</title>
...
<body>
    ...
    <div class="mainContainer">
        ...
        <div class="mainRight">
            <p class="location-bar">Página Inicial > Desportivo</p>
            <div class="rightItems">
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='desportivo' order by id_carro ASC LIMIT 4";
                ...
                <div class="colunasCarro">
                    <?php
                        ...
                        $select = "select * from carros where classeVeiculo='desportivo' and id_carro > 4 order by id_carro ASC LIMIT 4";
                        $connect = mysqli_query($con, $select);
